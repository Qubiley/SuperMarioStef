...
class ParticleEffect(pygame.sprite.Sprite):
    def __init__(self,pos,type):
        ...
        if type == 'fire_bullet_explosion':
            self.frames = import_folder('../graphics/bullet_explosion/fire')
        if type == 'ice_bullet_explosion':
            self.frames = import_folder('../graphics/bullet_explosion/ice')
